...
exports.createDBifNotExists = async () => {
    ...
    db.serialize(() => {
        ...
        db.run('CREATE TABLE IF NOT EXISTS project_users (project_id INTEGER, user_address TEXT, FOREIGN KEY(project_id) REFERENCES projects(id), FOREIGN KEY(user_address) REFERENCES users(address))');
    });
}
